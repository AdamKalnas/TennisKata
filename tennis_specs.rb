...
describe Tennis, "#begining of game" do
  ...
  it 'player 1 has advantage after scoring in duece' do
    setup_duece
    @tennis.point_scored(1)
    @tennis.score.should eq 'Advantage player 1'
  end

  it 'player 2 has advantage after scoring in duece' do
    setup_duece
    @tennis.point_scored(2)
    @tennis.score.should eq 'Advantage player 2'
  end

  it 'player 1 wins in duece' do
    setup_duece
    @tennis.point_scored(1)
    @tennis.point_scored(1)
    @tennis.score.should eq 'Player 1 wins!'
